...
- Checks: Windows/Ubuntu foundation workflow plus a separate Windows E-01 workflow. Local E-01 evidence records three passing runs; hosted results are linked in its report.
