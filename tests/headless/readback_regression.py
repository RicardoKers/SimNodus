"""Validate bounded readback ordering and final commit gates using actual fixture pipes."""
import argparse
import hashlib
import json
import os
...
def main():
    ...
    names=("valid","missing","wrong-code","wrong-magic","wrong-time","short","extra","negative","overflow",
           "duplicate","early","unprepared","pending-adc","disabled","duplicate-enable","late-enable")
    try:
        for name in names:
