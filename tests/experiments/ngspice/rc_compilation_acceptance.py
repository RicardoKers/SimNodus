"""Explicit owned-project compiler acceptance using the unchanged E-01 host."""
import argparse
import hashlib
import json
...
def main():
    ...
    try:
        ...
        rejected = compiler.compile_project(doc, package)
